...
const PAIRS_DEFINITIONS = [
  ...
  // Grid search 08/06/2026: score 21.33 | 83.3% WR | 0.71% exp | 12T | PF:10.41
  { id:'gbpusd_eurusd', instrA:'GBP/USD', instrB:'EUR/USD',
    epicA:'CS.D.GBPUSD.TODAY.IP', epicB:'CS.D.EURUSD.TODAY.IP',
    minDays:60, lookbackDays:60, entryZ:2.0, exitZ:0.25, stopZ:3.5,
    description:'GBP/USD vs EUR/USD — dollar pairs, 83.3% WR, PF 10.41 ⭐' },
  // Grid search 08/06/2026: score 27.13 | 72.7% WR | 4.5% exp | 11T | PF:2.50
  { id:'brent_gold', instrA:'Brent Oil', instrB:'Gold',
    ...
    minDays:60, lookbackDays:60, entryZ:1.75, exitZ:0.25, stopZ:2.5,
    liveToDbScaleA: 0.01,
    liveToDbScaleB: 1.0,
    description:'Brent vs Gold — risk asset ratio, 72.7% WR, 4.5% exp' },
  // Grid search 08/06/2026: score 17.41 | 75% WR | 1.03% exp | 8T | PF:7.97
  { id:'eurusd_eurgbp', instrA:'EUR/USD', instrB:'EUR/GBP',
    ...
    description:'EUR triangular relationship — 75% WR, only trade extreme 2.5σ dislocations' },
  // ── GRID SEARCH DEPLOY TIER — added 27/05/2026 ────────────────────────────
  // Grid search 08/06/2026: score 36.91 | 80% WR | 1.04% exp | 10T | PF:14.03
  // Updated from 2.25σ/0.75σ → 2.5σ/0.5σ on accurate data
  { id:'dow_sp500', instrA:'Dow Jones', instrB:'S&P 500',
    epicA:'IX.D.DOW.DAILY.IP', epicB:'IX.D.SPTRD.DAILY.IP',
    minDays:60, lookbackDays:60, entryZ:2.5, exitZ:0.5, stopZ:3.0,
    description:'Dow vs S&P 500 — US mega-cap divergence, 80% WR, PF 14.03 ⭐' },
  ...
  // Grid search 08/06/2026: score 11.50 | 77.8% WR | 1.24% exp | 18T | PF:2.81
  // Updated lookback 60d → 45d, WR improves from 66.7% to 77.8%
  { id:'ftse_sp500', instrA:'FTSE 100', instrB:'S&P 500',
    epicA:'IX.D.FTSE.DAILY.IP', epicB:'IX.D.SPTRD.DAILY.IP',
    minDays:45, lookbackDays:45, entryZ:2.0, exitZ:1.0, stopZ:3.0,
    description:'FTSE vs S&P 500 — UK/US equity divergence, 77.8% WR at 2σ ⭐' },
